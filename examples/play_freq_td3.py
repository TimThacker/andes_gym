...
rocof_record.to_csv(save_dir + "andes_primfreq_td3_rocof_multidist_010.csv", index=False)
...
coord_record.to_csv(save_dir + "andes_primfreq_td3_coord_multidist_010.csv", index=False)
freqRec = pd.DataFrame(env.best_episode_freq)
freqRec.to_csv(save_dir + "andes_primfreq_td3_sim_multidist_010.csv", index=False)
gov_tm = pd.DataFrame(env.best_episode_govdata)
gov_tm.to_csv(save_dir + "andes_primfreq_td3_govdata_multidist_010.csv", index=False)
...
plt.savefig(save_dir + "fig_primfreq_dynamics_multidist_010.pdf")
